...
The VM/PC collection is available as an early, partial reference. It currently includes shared authentication, IP asset operations, Host List V2-V6, and Host Update V2; it is not yet a complete API reference. The coverage register shows what is currently represented and what remains.
